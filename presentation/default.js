...
app.get("/", async function (req,res){
    ...
    const response = await fetch("http://locationservice:81")
...
app.get("/configuratorHyperionHalo", async function (req, res){
    const response = await fetch("http://configuratorservice:86/HyperionHalo")
    const jsonresponse = await response.json()
...
app.get("/configuratorTraverse", async function (req, res){
    const response = await fetch("http://configuratorservice:86/Traverse")
    const jsonresponse = await response.json()
...
app.get("/testdrive", async function (req, res){
    const response = await fetch("http://testdriveservice:82")
    const jsonresponse = await response.json()
    res.render("testdrive.ejs", { showNavbar: true, carsAndTracks: jsonresponse })
})

app.get("/merch", async function (req, res){
    const response = await fetch("http://merchitemsservice:85")
    const jsonresponse = await response.json()
